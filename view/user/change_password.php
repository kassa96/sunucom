...
<div class=" container-fluid">
  ...
  <input id="email" name="email"type="hidden" class="form-control" value="<?php echo $user['email']; ?>">
     <input id="jeton" name="jeton"type="hidden" class="form-control" value="<?php echo $user['jeton']; ?>">
