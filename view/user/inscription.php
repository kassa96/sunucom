...
<div class=" container-fluid">
  ...
  <legend>Inscription </legend>
    ...
    <div id="panel-name" class="form-group">
      ...
      <input name="name"id="name" type="text" class="form-control"value="<?php echo$user['name'] ?>">
    ...
    <div id="panel-genre"class="form-group">
      <label > genre : </label>
      <span class="genre">
        <input name="genre"id="masculin" type="radio" value="m" <?php if ($user['genre']=="m") {
          echo "checked";
        }?>>
      <label for="masculin" > masculin </label>
      </span>
      <span> 
        <input name="genre"id="feminin" type="radio" value="f" <?php if ($user['genre']=="f") {
          echo "checked";
        }?>>
    ...
    <button type="submit"  id="inscrire-btn" class="btn btn-primary btn-md">S'inscrire</button>
    </fieldset>
</form>
  </div>
  </section>
...
<script type="text/javascript" src=<?php echo '"'.urlInscriptionScript().'"'; ?>></script>
