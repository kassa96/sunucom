...
<div class=" container-fluid">
  ...
  <legend>Nous contacter </legend>
   <div id="panel-error">
      ...
      <div id="erreur-contact" class="alert alert-block alert-danger" style=" <?php if ($contact['message']=="") {echo "display:none";}
      ?>">
    ...
    <div id="panel-email" class="form-group ">
      ...
      <input name="email"id="email" type="text" class="form-control" value="<?php echo $contact['email'] ?>">
    ...
    <div id="panel-contenu" class="form-group">
      ...
      <textarea id="contenu"name="contenu" class="form-control" ><?php 
         echo $contact['contenu'];
                 ?></textarea>
            <span id="error-contenu"class="help-block"style="display:none"></span>

    </div>
    <button  id="contact-btn" class="btn btn-primary btn-md">envoyer</button>
    </fieldset>
</form>
  </div>
  </section>
...
<script type="text/javascript" src=<?php echo '"'.urlScript("contact").'"'; ?>></script>
